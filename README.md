# Welcome to my acronym generator!
### I made this so that I could put cryptic information in my discord bio for my friends to guess

The program is meant to be run with `python acronym_generator.py`
This will take all text, turn all hyphens into spaces, remove all punctuation, then make an acronym in all caps.
